...
3. Создаём ветку с предлагаемыми изминениями (для простоты можно брать название description)
4. Производим изменения только в этой ветке.
5. Комитим изменения, которые сделали. В комментарии не забываем описать то, что мы предлагаем. ***По-армейски - кратко и ясно***
6. Отправляем эти изменения на свой аккаунт в Github. Делаем это с помощью команды *"git push --set-upstream origin description"*. Этой командой мы проталкиваем изменения с созданием новой ветки на Github не затрагиваю основную ветку. 
7. Заходим на Github, проверяем наличие изменений в ветке, если всё the best, можем предложить внести изменения основному автору проекта.
